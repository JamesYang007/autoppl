...
struct convert_to_cont_param
{};

template <class T>
struct convert_to_cont_param<T,
...
template <class T>
using convert_to_cont_param_t = 
    typename convert_to_cont_param<T>::type;
...
inline constexpr auto uniform(MinType&& min_expr,
                              MaxType&& max_expr)
{
    using min_t = details::convert_to_cont_param_t<MinType>;
    using max_t = details::convert_to_cont_param_t<MaxType>;
...
{
    using mean_t = details::convert_to_cont_param_t<MeanType>;
    using stddev_t = details::convert_to_cont_param_t<StddevType>;
...
{
    using p_t = details::convert_to_cont_param_t<ProbType>;
